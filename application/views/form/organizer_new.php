          ...
          <div class="col-lg-10">
            <select class="form-control" id="select" name="user_select">
              ...
              <?php
                ...
                $query=$this->db->query('Select reg_no,name from user where id_user in(Select id_user from person_tour where id_tour='.$default_tour. ' and user_type_id=1)');

                foreach ($query->result() as $user_obj){
                  echo "<option value=".$user_obj->reg_no.">".$user_obj->name."(".$user_obj->reg_no.")</option>";
                }
