  ...
  <table class="table table-hover">
        ...
        <tbody>
          <?php 
            ...
            $query=$this->db->query('Select * from user where id_user in(Select id_user from person_tour where id_tour='.$default_tour. ' and payment_confirm=1 and user_type_id=5)');
            ...
            foreach ($query->result() as $alumni_obj)
            {
                ...
                <td>".$alumni_obj->create_date."</td>
                 ...
                 <td>
                  <a href='".base_url()."confirmed_user/delete/".$alumni_obj->id_user."' class='btn btn-danger btn-sm'>Delete</a>
                </td>
               </tr>
               ";
