  ...
  <table class="table table-hover">
        ...
        <tbody>
          <?php 
            ...
            $query=$this->db->query('Select * from user where id_user in(Select id_user from person_tour where id_tour='.$default_tour. ' and payment_confirm=0 and (user_type_id=1 or user_type_id=6))');
            ...
            foreach ($query->result() as $student_obj)
            {
                ...
                <td>
                  <a href='".base_url()."registered_user/confirm_student/".$student_obj->id_user."' class='btn btn-primary btn-sm'>Payment Confirm</a>
                </td>
                 <td>
                  <a href='".base_url()."registered_user/delete/".$student_obj->id_user."' class='btn btn-danger btn-sm'>Delete</a>
                </td>
               </tr>
               ";
